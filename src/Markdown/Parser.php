...
class Parser
{
	...
	public function parseFile(string $path): array
	{
		...
		$cacheEnabled = $kirby->option('moinframe.kirby-paradocs.cache', true);
		...
		// Save to cache - use file modification time in key for auto-invalidation
		if ($cacheEnabled) {
			$cache->set($cacheKey, $result, 60 * 24); // Cache for 24 hours
		}
