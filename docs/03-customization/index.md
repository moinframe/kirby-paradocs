...
The `paradocs.parser.ready` hook is a key extension point that lets you register custom markdown processors. See [Custom Processors](../04-custom-processors/01-processors.md) for details.
